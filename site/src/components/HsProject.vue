<template>
  <div
    ...
    class="project-wrapper text-left" style="position: relative;"
  >
    <div
    ...
    <div class="buttons" style="max-width: 1280px;">
        <div @click="nextSlide()" class="arrow" style="transform: rotate(180deg)"></div>
      </div>
  ...
  <div
    ...
    "
    class="project-wrapper image-center"
  >
